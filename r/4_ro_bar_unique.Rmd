...
saveRDS(ro_total_unique_rbind, "../intermediate_files/ro_total_unique_rbind.rds")
write.csv(ro_total_unique_rbind, "../intermediate_files/ro_total_unique_rbind.csv")
...
ro_unique_bar <- ggplot(ro_total_unique_rbind, aes(x=Host, fill=Family, y=rel_abun)) +
