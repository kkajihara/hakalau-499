...
readRDS("../intermediate_files/rarefied_physeqs.rds")
...
## Merging the host columns into one matrix
...
# save for later
saveRDS(ak_full_mat, "../intermediate_files/ak_full_mat.rds")
write.csv(ak_full_mat, "../intermediate_files/ak_full_mat.csv")
...
# save for later
saveRDS(ak_full_mat_pa, "../intermediate_files/ak_full_mat_pa.rds")
write.csv(ak_full_mat_pa, "../intermediate_files/ak_full_mat_pa.csv")
