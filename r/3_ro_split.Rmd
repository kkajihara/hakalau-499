...
# save for later
saveRDS(ro_full_mat, "../intermediate_files/ro_full_mat.rds")
write.csv(ro_full_mat, "../intermediate_files/ro_full_mat.csv")
...
# save for later
saveRDS(ro_full_mat_pa, "../intermediate_files/ro_full_mat_pa.rds")
write.csv(ro_full_mat_pa, "../intermediate_files/ro_full_mat_pa.csv")
