...
# Create phyloseq object
unrarefied_physeq <- qza_to_phyloseq(features="../data/full-set-tax/maarjam95-90-80 ncbi-80/merged-glom-only-final-no-negs.qza", 
                                     tree="../data/full-set-tax/maarjam95-90-80 ncbi-80/rooted-tree.qza", 
                                     taxonomy="../data/full-set-tax/maarjam95-90-80 ncbi-80/total-merged-classification.qza", 
