...
## This is more to access the qiime artifact data, doesn't actually have to do with the phyloseq object yet

# Read in feature table
asvs <- read_qza("../data/full-set-tax/maarjam95-90-80 ncbi-80/merged-glom-only-final-no-negs.qza")

# Read in metadata
metadata <- read.table(file="../data/haka-metadata.tsv", sep="\t", header=TRUE, stringsAsFactors = TRUE)

# tree
tree <- read_qza("../data/full-set-tax/maarjam95-90-80 ncbi-80/rooted-tree.qza")

# Read in taxonomy
taxonomy <- read_qza(file="../data/full-set-tax/maarjam95-90-80 ncbi-80/total-merged-classification.qza")

list.files("../data/full-set-tax/")
...
# Create phyloseq object
unrarefied_physeq <- qza_to_phyloseq(features="../data/full-set-tax/maarjam95-90-80 ncbi-80/merged-glom-only-final-no-negs.qza", tree="../data/full-set-tax/maarjam95-90-80 ncbi-80/rooted-tree.qza", taxonomy="../data/full-set-tax/maarjam95-90-80 ncbi-80/total-merged-classification.qza", metadata="../data/haka-metadata.tsv")
