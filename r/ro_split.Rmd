...
#Add grass
ro_skookapg_mat <- merge(ro_skookap_mat, ro_grass_mat, by="row.names", all=T)
rownames(ro_skookapg_mat) <- ro_skookapg_mat[,1]
ro_skookapg_mat[,1] <- NULL
...
ro_skookag_mat[ro_skookag_mat > 0] <- 1
...
# Mroes presence absence (turns any value > 0 into 1)
